...
FOUNDATION_EXPORT UIColor   *UIColorFromString(NSString *hexCode, CGFloat opacti) NS_AVAILABLE_IOS(7_0);
FOUNDATION_EXPORT NSString  *NSStringFromUIColor(UIColor *color) NS_AVAILABLE_IOS(7_0);
