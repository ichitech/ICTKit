 ...
 */
+ (NSArray * _Nonnull) arrayRandomFromArray:(NSArray * _Nonnull)array
 limit:(NSInteger)count  NS_DEPRECATED_IOS(2_0, 6_1, "arrayRandomFromArray:limit: has been replaced by arrayByRandomCount:");
