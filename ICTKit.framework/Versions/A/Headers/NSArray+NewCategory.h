 ...
 */
+ (NSArray *) arrayRandomFromArray:(NSArray *)array limit:(NSInteger)count  NS_DEPRECATED_IOS(2_0, 6_1, "arrayRandomFromArray:limit: has been replaced by arrayByRandomCount:");

- (NSArray *) arrayByRandomCount:(NSInteger)count NS_AVAILABLE_IOS(7_0);
